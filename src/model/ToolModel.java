...
import seleniumscripts.OpenGmail;
import seleniumscripts.OpenJiraBingo;
...
public class ToolModel {
	...
	public void openJira(String jiraQuerry) {

		OpenJiraBingo openJira = new OpenJiraBingo(jiraQuerry, this);
		Thread thread = new Thread(openJira);
		thread.start();

	}

	public void openGmail() {
		OpenGmail openGmail = new OpenGmail(this);
		Thread thread = new Thread(openGmail);
		thread.start();
